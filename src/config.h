...
typedef struct Config {
  ...
  // Lobby display name for netplay (config.ini [General] NetplayPlayerName).
  ...
  /* Per-player launcher device: "none", "keyboard", or SDL joystick GUID.
   * Empty = legacy (EnableGamepad + has_keyboard_controls). */
  char input_device[2][40];
