...
#
# Usage:
#   bash tools/build-linux.sh                 # prod build, no AppImage (default)
...
#   bash tools/build-linux.sh --package      # also wrap into an AppImage
#   bash tools/build-linux.sh --no-package    # configure + build only (default)
